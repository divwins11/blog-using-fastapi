...
#for db where base&engine for creating tables
...
#dependency injection to get a database session for this endpoint
...
# It checks if the specified user_id exists before creating the post.
@app.post(
    "/api/posts",
